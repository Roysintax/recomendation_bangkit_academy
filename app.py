...
model_path = r"E:\data\rekomendasiByStoryID.h5"
...
vectorizer_path = r"E:\data\vectorizer.pkl"
...
def load_data():
    try:
        ...
        df_story['combined_text'] = df_story['combined_text'].apply(preprocess_text)
        return df_story
...
def recommend_stories():
    ...
    recommended_story_indices = [idx for idx in recommended_story_indices if idx < len(df_story)]
